...
export default async function Home(){
  const[articles,companies,events,segmentProfiles,home,settings]=await Promise.all([contentRepository.listArticles(),contentRepository.listCompanies(),contentRepository.listEvents(),contentRepository.listSegmentProfiles(),configRepository.getHome(),configRepository.getSettings()]);
